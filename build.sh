...
BUILD_QTQUICK3D_PHYSICS_EXAMPLES=${BUILD_QTQUICK3D_PHYSICS_EXAMPLES:-OFF}
...
echo "BUILD_QTQUICK3D_PHYSICS_EXAMPLES: $BUILD_QTQUICK3D_PHYSICS_EXAMPLES"
...
cmake -DCMAKE_PREFIX_PATH=/usr/local/Cellar/qt/6.9.1 \
    ...
    -DBUILD_QTQUICK3D_PHYSICS_EXAMPLES=$BUILD_QTQUICK3D_PHYSICS_EXAMPLES ..
make -j8
